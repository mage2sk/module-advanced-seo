...
class FullBuilder
{
    public const XML_ENABLED       = 'panth_seo/llms_txt/generate_full_llms';
    public const XML_SHIPPING_PAGE = 'panth_seo/llms_txt/shipping_page';
    public const XML_RETURNS_PAGE  = 'panth_seo/llms_txt/returns_page';
    public const XML_ABOUT_PAGE    = 'panth_seo/llms_txt/about_page';
    public const XML_FAQ_PAGE      = 'panth_seo/llms_txt/faq_page';
