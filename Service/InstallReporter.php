<?php
/**
 * Standalone install + heartbeat reporter for Panth_AdvancedSEO.
 *
...
class InstallReporter
{
    ...
    public const MAGENTO_MODULE = 'Panth_AdvancedSEO';

    /** Composer package name reported to the receiver. */
    public const COMPOSER_PACKAGE = 'mage2kishan/module-advanced-seo';
