 ...
 *
 * SAFE: If Panth_DynamicForms is not installed, Magento silently skips the
...
class DynamicFormAiPlugin
{
    ...
    /**
     * Inject AI generate buttons into the dynamic form edit page.
     *
     * @param mixed                $subject  Panth\DynamicForms\Ui\DataProvider\FormDataProvider
     * @param array<string,mixed>  $result
     * @return array<string,mixed>
     */
    public function afterGetMeta($subject, array $result): array
    {
        // Safety check: only proceed if DynamicForms module is actually installed
